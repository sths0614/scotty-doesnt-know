...
Declare_Any_Class( "Shape",
  {
    ...
    'draw': function( graphics_state, model_transform, material, texture_transform )                                       // The same draw() function is used for every shape -
      { 
          var toSendTexTransform = mat4();
          if (texture_transform) {
              toSendTexTransform = texture_transform;
          }
        ...
        active_shader.update_uniforms( graphics_state, model_transform, material, toSendTexTransform );                     // vertex list in the GPU we consult.
